...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="CouponId" v-model="value.couponId"/>
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="OrderDate" v-model="value.orderDate"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="OrderCancelDate" v-model="value.orderCancelDate"/>
          </div>
          <div class="grey--text ml-4" v-else>
            OrderCancelDate :  {{value.orderCancelDate }}
          </div>

          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="Amt" v-model="value.amt"/>
          </div>
          <div class="grey--text ml-4" v-else>
            Amt :  {{value.amt }}
          </div>
